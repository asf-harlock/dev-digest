...
| `08-smart-diff` | PR #482 → Files changed tab → Smart Diff groups (Core/Tests/Wiring/Docs/Boilerplate), a seeded CRITICAL finding anchored inline, and the Original-order fallback |
